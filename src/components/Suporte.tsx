...
import { useSuporte } from "@/hooks/SuporteHooks/useSuporte";
    ...
    <div className="mx-auto w-full max-w-6xl px-4 py-6 md:px-6 lg:px-8 container-expansivel-suporte">
      <div className="mb-6 space-y-2">
        ...
        <p className="max-w-2xl text-sm text-muted-foreground md:text-base">
          Envie sua dúvida, problema técnico ou solicitação. Use o formulário
          abaixo para registrar o contato com mais contexto. Seu nome e email
          serão do seu perfil cadastrado para que possamos responder. Quanto
        ...
        <Card className="border-border bg-card text-card-foreground shadow-2xl backdrop-blur-xl">
          <CardHeader className="pb-2">
            ...
            <CardDescription className="text-muted-foreground">
              Resposta mais rápida quando você descreve o que aconteceu e em
              qual tela o erro apareceu.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex flex-col gap-3 border-t border-border pt-4 sm:flex-row sm:items-center sm:justify-between">
                <p className="text-sm text-muted-foreground">
                  Seu pedido será enviado com os dados do formulário para o time
                  de suporte.
                </p>
                <Button
                  type="submit"
