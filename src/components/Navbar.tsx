...
export function Navbar({
  ...
  const handleSair = async () => {
    ...
    try {
      ...
      if (error) {
        console.warn(
          "Erro ao tentar deslogar no Supabase, prosseguindo com a limpeza local:",
          error,
        );
      }
    } catch (error: any) {
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent sideOffset={10} align="end">
            ...
            <DropdownMenuItem
              ...
              className="cursor-pointer"
            >
              <LogOutIcon className="icones-minha-conta mr-2 h-4 w-4" />{" "}
              {saindo ? "Saindo..." : "Sair"}
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
          ...
          <DialogContent className="sm:max-w-[425px]">
            ...
            <div className="flex flex-col items-center gap-4 py-6">
              ...
              <div className="text-center space-y-1">
                ...
                <p className="text-sm font-semibold uppercase text-purple-500">
                  {perfil?.role}
                </p>
