                ...
                <div className="w-full md:w-1/2 p-6 md:p-10 lg:p-12 flex flex-col justify-center overflow-y-auto">
                    <div className="flex items-center gap-3 mb-4">
                        <div className="w-12 h-12 rounded-full border border-purple-500/30 flex items-center justify-center bg-black/20 overflow-hidden">
                            <img src={getAssetPath("/Logos/Logo.png")} alt="Logo da Escola Nexus" className="w-11 h-11 object-contain" />
                        </div>
                    ...
                    <p className="text-[#9f95ba] text-base mb-6 md:mb-6">
                        {isLogin ? 'Faça login para acessar sua plataforma de estudos.' : 'Junte-se a nós para começar a explorar.'}
                    </p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input id="email" type="email" placeholder="seu@email.com" value={email} onChange={(e) => setEmail(e.target.value)} required className="h-12 bg-transparent border-purple-500/25 text-white pl-11 rounded-xl focus-visible:ring-2 focus-visible:ring-purple-500 focus-visible:border-purple-500" />
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input id="password" type={showPassword ? "text" : "password"} placeholder="Sua senha" value={password} onChange={(e) => setPassword(e.target.value)} required className="h-12 bg-transparent border-purple-500/25 text-white pl-11 pr-11 rounded-xl focus-visible:ring-2 focus-visible:ring-purple-500 focus-visible:border-purple-500" />
                                <button type="button" onClick={visualizarSenha} className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-500 hover:text-slate-300 transition-colors cursor-pointer">
                        ...
                        {isLogin && (
                            <div className="flex items-center justify-between text-sm pt-1">
                                <div className="flex items-center space-x-2">
                                    <Checkbox id="lembrar" className="border-slate-600 data-[state=checked]:bg-purple-600" />
                                    <Label htmlFor="lembrar" className="text-slate-400 font-normal">Lembrar de mim</Label>
                                </div>
                                {/* Não vai existir sistema de recuperação de senha isso é apenas um exemplo */}
                                <a href="#" className="text-purple-400 hover:text-purple-300 transition-colors">Esqueceu sua senha?</a>
                            </div>
                        )}

                        <Button type="submit" disabled={loading} className="mt-4 h-12 w-full rounded-xl border-0 text-base font-semibold text-white bg-gradient-to-r from-[#8B5CF6] to-[#EC4899] hover:from-[#7C3AED] hover:to-[#DB2777] shadow-[0_8px_30px_rgba(236,72,153,0.2)]">
                    ...
                    <div className="mt-6 text-center text-sm text-slate-400">
                        ...
                        <button onClick={(e) => { e.preventDefault(); setIsLogin(!isLogin); }} className="text-purple-400 cursor-pointer font-semibold hover:text-purple-300 transition-colors">
