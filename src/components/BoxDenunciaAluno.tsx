    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/70 backdrop-blur-sm px-4">
      <div className="bg-card text-card-foreground border border-border rounded-lg p-6 w-full max-w-xl shadow-lg">
        ...
        <p className="text-sm text-muted-foreground mb-4">
          Selecione o motivo da denúncia e, se quiser, adicione mais detalhes.
        </p>
          ...
          <div className="grid grid-cols-2 gap-2">
            {motivos.map((m) => (
              <button
                ...
                className={`cursor-pointer flex items-center gap-3 px-2 py-2 text-left text-sm transition-colors focus:outline-none ${
                  motivoSelecionado === m
        ...
        <div className="flex justify-end gap-2">
          ...
          <Button
            ...
            className="px-4 cursor-pointer bg-destructive text-destructive-foreground hover:bg-destructive/90"
            disabled={sending}
          >
