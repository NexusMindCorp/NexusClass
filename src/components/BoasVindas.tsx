      ...
      <div className="flex flex-col flex-1 justify-center">
        <CardHeader className="text-center pt-8 pb-4">
          ...
          <CardDescription className="text-base text-muted-foreground mt-3 max-w-lg mx-auto leading-relaxed">
            {isProfessor ? (
              <>
                Olá, Prof. {nomeUsuario}! Seu ambiente virtual de ensino está
                pronto. Aqui você pode gerenciar suas turmas, disponibilizar
                materiais e acompanhar o progresso dos seus alunos. Além disso,
                temos a tecnologia de Inteligência Artificial para ajudar vocês
                ser mais produtivo.
              </>
            ) : isAluno ? (
              <>
                Olá, {nomeUsuario}! Seu ambiente virtual de aprendizagem está
                pronto. Aqui você pode acompanhar suas disciplinas, acessar seus
                materiais e interagir com suas turmas. Além disso, temos a
                tecnologia de Inteligência Artificial para ajudar vocês a
                aprender mais eficientemente.
              </>
            ) : (
              <>
                Olá, {nomeUsuario}! Seu ambiente virtual está pronto. Explore os
            ...
            {isAluno && (
              <>
                <p className="text-sm text-foreground mb-4 font-medium">
                  Ainda não faz parte de nenhuma turma ou quer expandir seus
                  estudos?
                </p>
            ...
            {isProfessor && (
              <div className="flex flex-col items-center">
                ...
                <div className="space-y-3 text-sm text-muted-foreground leading-relaxed">
                  <p>
                    Como você está vendo esta tela, significa que nenhuma
                    disciplina foi vinculada ao seu perfil até o momento.
                  </p>
                  <p>
                    Por favor, aguarde a alocação de suas turmas ou entre em
                    contato com a administração caso acredite que isso seja um
                    erro.
                  </p>
                </div>
              </div>
