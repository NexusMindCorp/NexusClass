...
export function PerfilAvatar( { classNameAvatar, classNameDiv, foto, tipo = 'usuario', palavra }: PerfilAvatarProps) {
    const tipoPalavra = tipo === 'usuario' ? getCorNomeUsuario(palavra || "U") : getCorMateria(palavra || "U");
    ...
    return (
        <Avatar {...classNameAvatarFinal}>
            {!foto || foto === "" ? (
                ...
                <AvatarImage src={foto} alt="Foto do Usuário" className="object-cover" />
            )}
        </Avatar>
    )
}