...
export function InfoAplicacao() {
    ...
    const tecnologias = [
        { nome: "Vite React", icone: Zap, cor: "text-blue-600 dark:text-blue-400 bg-blue-500/10 border-blue-500/20" },
        { nome: "TypeScript", icone: Code2, cor: "text-blue-700 dark:text-blue-500 bg-blue-500/10 border-blue-500/20" },
        { nome: "Tailwind CSS", icone: Layers, cor: "text-teal-600 dark:text-teal-400 bg-teal-500/10 border-teal-500/20" },
        { nome: "Supabase", icone: Database, cor: "text-emerald-600 dark:text-emerald-400 bg-emerald-500/10 border-emerald-500/20" },
        { nome: "Vercel", icone: Cloud, cor: "text-neutral-700 dark:text-neutral-400 bg-neutral-500/10 border-neutral-500/20" },
        { nome: "Resend", icone: Mail, cor: "text-purple-600 dark:text-purple-400 bg-purple-500/10 border-purple-500/20" },
        { nome: "API Gemini", icone: Sparkles, cor: "text-amber-600 dark:text-amber-400 bg-amber-500/10 border-amber-500/20" },
        { nome: "Lucide Icons", icone: Layers, cor: "text-pink-600 dark:text-pink-400 bg-pink-500/10 border-pink-500/20" },
        { nome: "Shadcn UI", icone: Info, cor: "text-indigo-600 dark:text-indigo-400 bg-indigo-500/10 border-indigo-500/20" },
    ];
            ...
            <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    {devs.map((dev) => (
                        ...
                        >
                            <div className={`flex h-12 w-12 items-center justify-center rounded-full ${dev.corGradiente} text-lg font-bold text-white shadow-sm ring-2 ring-background transition-transform group-hover:scale-105`}>
                                {dev.iniciais}
                            </div>
